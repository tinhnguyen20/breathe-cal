class City < ActiveRecord::Base
  ...
  def self.get_api_key(i)
    ["iXMydxAY4S3desw1RAGAgAWERu8IfqJc","nvdxlfErdFcQssANvU52VQYNj9JauI4z", "IGE0pfTgoL1OGJKvEcnAbbqpmQGjvbpo", "5NMWDxuXmQpNLf7AQ2gj0Y8uBkLXT8q3", "CdE0YANGAu4AsDAReO0e6CZ01RwfFe9a"][i]
  end
